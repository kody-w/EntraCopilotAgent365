...
class LearnNewAgentAgent(BasicAgent):
    ...
    def perform(self, **kwargs):
        ...
        success = self.storage_manager.write_file('agents', file_name, cleaned_implementation)
        ...
        try:
            file_content = self.storage_manager.read_file('agents', file_name)
            ...
            if '[[[' in file_content or ']]]' in file_content:
                ...
                cleanup_success = self.storage_manager.write_file('agents', file_name, cleaned_content)
